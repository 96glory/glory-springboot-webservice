...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        // when
        mockMvc.perform(post(url).contentType(MediaType.APPLICATION_JSON_UTF8).content(new ObjectMapper().writeValueAsString(requestDto)))
    ...
    public void Posts_수정된다() throws Exception {
        ...
        // when
        mockMvc.perform(put(url).contentType(MediaType.APPLICATION_JSON_UTF8).content(new ObjectMapper().writeValueAsString(requestDto)))
                .andExpect(status().isOk());
